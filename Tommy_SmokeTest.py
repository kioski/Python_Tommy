...
class TommyTests(unittest.TestCase):
    ...
    def test_1bContacts_NewChat(self):
        ...
        try:
            self.assertEqual(Sample_Text, driver.find_element_by_class_name(SelectorClass_AssertInputtedText).find_elements_by_tag_name("div")[1].get_attribute("innerText"))

        except AssertionError as Error:

            print("Error_2: " + str(Error))
